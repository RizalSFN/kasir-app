    ...
    <div class="m-5">
        <div class="flex items-center justify-between" id="laporan-filter">
            ...
            <a href="{{ route('petugas.transaksi.proses') }}"
                class="py-2 px-6 text-white font-medium flex items-center bg-blue-500 hover:bg-blue-600 rounded-md tracking-wide">
            ...
            <tbody>
                @foreach ($new_data as $transaksi)
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-3" id="hidden-print">
                            <a href="{{ route('petugas.transaksi.struk', $transaksi->id_penjualan) }}"
