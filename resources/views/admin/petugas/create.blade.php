...
@section('content')
    <div class="mt-5 ml-5 w-6/12 border border-gray-300 rounded-md">
        ...
        <form action="{{ route('admin.petugas.store') }}" method="POST" class="m-5 flex flex-col">
            @csrf
            <div class="flex items-center mt-5">
                <label for="nama" class="font-medium w-5/12">Nama</label>
                <div class="flex flex-col w-5/12">
                    <input type="text" name="nama" value="{{ old('nama') }}" id="nama" autofocus required
            ...
            <div class="flex items-center mt-5">
                <label for="password" class="font-medium w-5/12">Password</label>
                <div class="flex flex-col w-5/12">
