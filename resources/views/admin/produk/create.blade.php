...
@section('content')
    <div class="mt-5 ml-5 w-6/12 border border-gray-300 rounded-md">
        ...
        @endif
        <form action="{{ route('admin.produk.store') }}" method="POST" class="m-5 flex flex-col">
            @csrf
            <div class="flex items-center">
                ...
                <input type="text" name="id_produk" id="id_produk" value="{{ $new_id }}" readonly
                    class="bg-gray-200 p-2 w-5/12 outline-none">
            </div>
            ...
            <div class="flex items-center mt-5">
                ...
                <div class="flex flex-col w-5/12">
                    <div class="flex">
                        <input type="number" name="diskon_produk" id="diskon_produk" required
